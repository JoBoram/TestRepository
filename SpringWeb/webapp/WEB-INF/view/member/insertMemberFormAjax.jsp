...
<script type="text/javascript">
	function insertMember() {
		...
		// serialize : post 방식으로 문자를  만들어 준다.
		$.ajax({
			type : "post",
...
<body>
	...
	<form id="memberForm">
		...
		이름: <input type="text" name="memberName" maxlength="20" /><br /> 나이:
		<select name="memberAge">
			...
			placeholder="핸드폰 가운데 자리"> - <input type="number" id="hp3"
			name="hp3" maxlength="5" placeholder="핸드폰 뒷자리"> <input
			type="hidden" id="memberHp" name="memberHp" /> <br /> <input
			type="radio" name="memberSex" value="F">여자 <input
			type="radio" name="memberSex" value="M">남자 <br /> <br />
